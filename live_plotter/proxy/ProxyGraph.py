...
from live_plotter.Graph import Curve, DistributedCurve, SmoothedCurve
...
class ProxyCurve(ProxyGraph):
    ...
    def __init__(self, mode: str = None):
        super().__init__()
        self._server.append(CreateTask(self.id, ProxyCurve._create, mode))
...
class ProxySmoothedCurve(ProxyGraph):
    ...
    def __init__(self, smoothing: float, mode: str = None):
        super().__init__()
        self._server.append(CreateTask(self.id, ProxySmoothedCurve._create, smoothing, mode))
...
class ProxyDistributedCurve(ProxyGraph):
    ...
    def _create(mode: str = None, color: str = "blue", alpha: float = 1.0,
        ...
        from live_plotter.Graph import DistributedCurve
    ...
    def __init__(self, mode: str = None, color: str = "blue", alpha: float = 1.0, interpolate: bool = True):
        super().__init__()
        self._server.append(CreateTask(self.id, ProxyDistributedCurve._create, mode, color, alpha, interpolate))
